...
export function create_earth (scene: Scene, camera: ArcRotateCamera, sun_point_light: PointLight)
{
    ...
    // Uncomment when this bug is fixed: https://stackoverflow.com/questions/75204349/vitejs-serving-shader-file-with-wrong-none-mime-type
    let atmosphere = new AtmosphericScatteringPostProcess("atmosphere", earth, planet_radius, atmosphere_radius, sun_point_light, camera, scene)
